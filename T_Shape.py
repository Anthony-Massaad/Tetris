...
class TShape(Shape):
    def __init__(self, display):
        ...
        self.landed = False
        self.shape = [
            (self.surface, self.color, [401, 1, 29, 29]),
    ...
    def drawNext(self, first, second, third):
        ...
        if first is True:
            copyShape = [
                (self.surface, self.color, [80, 88, 29, 29]),
                (self.surface, self.color, [110, 88, 29, 29]),
                (self.surface, self.color, [140, 88, 29, 29]),
                (self.surface, self.color, [110, 118, 29, 29])
            ]
        elif second is True:
            copyShape = [
                (self.surface, self.color, [80, 250, 29, 29]),
                (self.surface, self.color, [110, 250, 29, 29]),
                (self.surface, self.color, [140, 250, 29, 29]),
                (self.surface, self.color, [110, 280, 29, 29])
            ]

        elif third is True:
            copyShape = [
                (self.surface, self.color, [80, 412, 29, 29]),
                (self.surface, self.color, [110, 412, 29, 29]),
                (self.surface, self.color, [140, 412, 29, 29]),
                (self.surface, self.color, [110, 442, 29, 29]),
            ]

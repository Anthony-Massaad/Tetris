...
#(0,6), (0,7), (1,7), (1,8) <- Z Not inverted Shape
# x = 251 + (30 * col)
# y = 1 + (30 * row)
...
class ZShape(Shape):
    def __init__(self, display):
        ...
        self.shape = [
            ...
            (self.surface, self.color, [491, 31, 29, 29])
        ]
    ...
    def drawNext(self, first, second, third):
        ...
        if first is True:
            copyShape = [
                ...
                (self.surface, self.color, [150, 118, 29, 29])
            ]
        elif second is True:
            copyShape = [
                ...
                (self.surface, self.color, [150, 280, 29, 29]),
            ]
            ...
            copyShape = [
                ...
                (self.surface, self.color, [150, 442, 29, 29]),
            ]

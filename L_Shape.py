...
# (0,6), (1,6), (2,6), (2,7) <- L not inverted Shape
...
class LShape(Shape):
    def __init__(self, display):
        ...
        self.shape = [
            ...
            (self.surface, self.color, [431, 61, 29, 29]),
            (self.surface, self.color, [461, 61, 29, 29])
        ]
        self.pivot = pygame.draw.rect(self.shape[1][0], self.shape[1][1], self.shape[1][2]).center
    ...
    def drawNext(self, first, second, third):
        ...
        if first is True:
            copyShape = [
                (self.surface, self.color, [100, 88, 29, 29]),
                (self.surface, self.color, [100, 118, 29, 29]),
                (self.surface, self.color, [100, 148, 29, 29]),
                (self.surface, self.color, [130, 148, 29, 29])
            ]
        elif second is True:
            copyShape = [
                (self.surface, self.color, [100, 250, 29, 29]),
                (self.surface, self.color, [100, 280, 29, 29]),
                (self.surface, self.color, [100, 310, 29, 29]),
                (self.surface, self.color, [130, 310, 29, 29])
            ]
        elif third is True:
            copyShape = [
                (self.surface, self.color, [100, 412, 29, 29]),
                (self.surface, self.color, [100, 442, 29, 29]),
                (self.surface, self.color, [100, 472, 29, 29]),
                (self.surface, self.color, [130, 472, 29, 29])
            ]

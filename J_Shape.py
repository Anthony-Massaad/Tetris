...
# (0,6), (1,6), (2,6), (2,5) <- L inverted Shape
# x = 251 + (30 * col)
# y = 1 + (30 * row)
...
class JShape(Shape):
    def __init__(self, display):
        ...
        self.shape = [
            ...
            (self.surface, self.color, [401, 61, 29, 29])
        ]
    ...
    def drawNext(self, first, second, third):
        ...
        if first is True:
            copyShape = [
                ...
                (self.surface, self.color, [70, 148, 29, 29])
            ]
        elif second is True:
            copyShape = [
                ...
                (self.surface, self.color, [70, 310, 29, 29])
            ]
        elif third is True:
            copyShape = [
                ...
                (self.surface, self.color, [70, 472, 29, 29])
            ]
